        ...
        <div class="card">
                <div class="card-body" style="border: 1px #111">
                    <div class="table-responsive">
                        <table class="table  all_appointments display" width="100%">
                            <thead class="text-uppercase thead-white">
                            <tr>
                                <th width="100">Status</th>
                                <th width="100">Client Name</th>
                                <th width="100">Clinic Name</th>
...
$(function () {
    ...
    $('.all_appointments:not(.ajaxTable)').DataTable({ buttons: dtButtons });
...
$(document).on('click', '.status', function(){
    ...
    $.ajax({
        url :"/admin/change_status/appointments",
        dataType:"json",
