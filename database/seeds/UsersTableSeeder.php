    ...
    public function run()
    {
        ...
        $type_of_trade_acts = [
            ...
            [
                ...
                'file'       => 'Workplace Safety & Health (Scaffolds) Regulations_scaffolding.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                ...
                'file'       => 'Workplace Safety and Health (Work at Heights) Regulations_scaffolding.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                ...
                'file'       => 'Workplace Safety & Health (General Provisions) Regulations 2006_scaffolding.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                ...
                'file'       => 'Workplace Safety & Health (Incident Reporting) Regulations_scaffolding.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                ...
                'file'       => 'Workplace Safety & Health (First Aid) Regulations 2006_scaffolding.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            //Painting
            [
                'id'         => '6',
                'title'      => 'WSH (Scaffold) Regulations',
                'file'       => 'Workplace Safety & Health (Scaffolds) Regulations_painting.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '7',
                'title'      => 'WSH (Work at Height) Regulations',
                'file'       => 'Workplace Safety and Health (Work at Heights) Regulations_painting.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '8',
                'title'      => 'WSH (General Provision) Regulations',
                'file'       => 'Workplace Safety & Health (General Provisions) Regulations 2006_painting.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '9',
                'title'      => 'WSH (Incident Reporting) Regulations',
                'file'       => 'Workplace Safety & Health (Incident Reporting) Regulations_painting.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '10',
                'title'      => 'WSH (First Aid) Regulations',
                'file'       => 'Workplace Safety & Health (First Aid) Regulations 2006_painting.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            //Tunnelling
            [
                'id'         => '11',
                'title'      => 'WSH (Scaffold) Regulations',
                'file'       => 'Workplace Safety & Health (Scaffolds) Regulations_tunnelling.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '12',
                'title'      => 'WSH (Work at Height) Regulations',
                'file'       => 'Workplace Safety and Health (Work at Heights) Regulations_tunnelling.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '13',
                'title'      => 'WSH (General Provision) Regulations',
                'file'       => 'Workplace Safety & Health (General Provisions) Regulations 2006_tunnelling.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '14',
                'title'      => 'WSH (Incident Reporting) Regulations',
                'file'       => 'Workplace Safety & Health (Incident Reporting) Regulations_tunnelling.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '15',
                'title'      => 'WSH (First Aid) Regulations',
                'file'       => 'Workplace Safety & Health (First Aid) Regulations 2006_tunnelling.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            //Excavation
            [
                'id'         => '16',
                'title'      => 'WSH (Scaffold) Regulations',
                'file'       => 'Workplace Safety & Health (Scaffolds) Regulations_excavation.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '17',
                'title'      => 'WSH (Work at Height) Regulations',
                'file'       => 'Workplace Safety and Health (Work at Heights) Regulations_excavation.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '18',
                'title'      => 'WSH (General Provision) Regulations',
                'file'       => 'Workplace Safety & Health (General Provisions) Regulations 2006_excavation.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            //Formwork
            [
                'id'         => '19',
                'title'      => 'WSH (Scaffold) Regulations',
                'file'       => 'Workplace Safety & Health (Scaffolds) Regulations_formwork.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '20',
                'title'      => 'WSH (Work at Height) Regulations',
                'file'       => 'Workplace Safety and Health (Work at Heights) Regulations_formwork.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
            [
                'id'         => '21',
                'title'      => 'WSH (General Provision) Regulations',
                'file'       => 'Workplace Safety & Health (General Provisions) Regulations 2006_formwork.pdf',
                'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),
            ],
